	 ...
	 @Transactional
	    public Rating addRatingToProduct(int productId, Rating rating) {
	        Products product = prodRepo.findById(productId)
	            .orElseThrow(() -> new ProductNotFoundException("Product with product id: " + productId + " not found."));
